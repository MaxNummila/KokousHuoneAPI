...
// Insert tietokantaan, luo varauksen huoneen nimellä, alku- sekä päättymisajalla ja luojan käyttäjätunnuksella
...
// List tietokannasta, tuo varauksen huoneen nimellä
...
// List tietokannasta, tuo varauksen huoneen id numerolla
const getBookingById = (id) => {
  return db.prepare('SELECT * FROM bookings WHERE id = ?').get(id);
};

// Delete, poistaa varauksen tietokannasta
